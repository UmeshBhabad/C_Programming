// Accept N numbers from user and return thedifference between largest and Smallest element.
...
int main()
{
    ...
    printf("Difference between Largest and Smallest element is %d", iRet);  // Display Output
