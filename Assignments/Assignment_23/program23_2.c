// Accept N numbers from user and accept one another number as No, return index of first occerence of that No.
...
int FirstOcc(int Arr[], int iSize, int iNo)                         // Function defination
{
...
int main()
{
    ...
    printf("Index first occurrence of %d is %d", iValue, iRet);     // Display Output
