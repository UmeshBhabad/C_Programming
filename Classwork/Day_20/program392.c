...
void InsertAtPos(PPNODE first, int iNo, int pos)                // Function defination
{
    ...
    iSize = Count(*first);                                      // Count Function
    ...
    {
        InsertFirst(first, iNo);                                // Insert at first position
    }
    else if(pos == iSize + 1)   // Last Position
    {
        InsertLast(first, iNo);                                 // Insert at Last Position
    }
    else
    {
        ...
        for(iCnt = 1; iCnt < (pos - 1); iCnt++)                 // Loop for traversal
        {
            temp = temp -> next;
        }
...
void DeleteAtPos(PPNODE first, int iNo, int pos)
{
    int iSize = 0;
