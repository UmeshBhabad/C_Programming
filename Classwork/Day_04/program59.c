...
// Optimized Program to check whether the given number is prime or not(declaring and updating flag in the for loop)
...
bool CheckPrime(int iNo)                                        // Function defination
{
    ...
    bool bFlag = false;                                         // Flag Variable   
    ...
    // Input : 6   iCnt = 2
    for(iCnt = 2, bFlag = true; iCnt <= iNo/2; iCnt++)          // declaring and updating flag in the for loop
    {
